...
export function Login() {
    ...
    return (
        <div className={`bg-white buttonClick duration-500 `}>
            ...
            background-animate"
                                    >
                                        <h2 className={`text-white text-4xl font-bold lg:mt-60 lg:ml-10 `}>Agent</h2>
                    ...
                    <div className="flex-1">
                        <div className="text-center">
                            ...
                            <div className="">
                                ...
                                <div className={`text-gray-800 buttonClick duration-500 text-4xl font-bold text-center`} >Agent</div>
                            </div>
