        ...
        <div className="grid grid-cols-2">
          <div className="pl-8">
            ...
            <div className="mt-2 flex space-x-2">
              ...
              <div
                className={`text-xl font-bold ${currentVisitors / bar.max_people_in_bar < 0.5
                  ? 'text-green-400'
                  : currentVisitors / bar.max_people_in_bar < 0.75
                    ? 'text-yellow-400'
                    : currentVisitors / bar.max_people_in_bar < 1
                      ? 'text-orange-500'
                      : 'text-red-600'
                  }`}
              >
