...
const RestaurantCard: React.FC<Restaurant> = ({
  ...
  return (
    <div
      key={restaurant_id} className="px-2"
    ...
    >
      <div className="flex">
        ...
        <div className="p-3 w-2/3">
          {/* Restaurant Name */}
          <a href="#">
            <h5 className="mb-3 text-xl font-semibold text-gray-900 dark:text-white hover:text-blue-500 transition-colors duration-200">
              {restaurant_name}
            </h5>
          </a>

          {/* Visitor Count */}
          <div className="flex space-x-1 text-lg text-gray-900 ">
            <svg fill="#000000" width="25px" height="25px" viewBox="-3 0 19 19" xmlns="http://www.w3.org/2000/svg" className="mt-0.5 cf-icon-svg"><path d="M12.517 12.834v1.9a1.27 1.27 0 0 1-1.267 1.267h-9.5a1.27 1.27 0 0 1-1.267-1.267v-1.9A3.176 3.176 0 0 1 3.65 9.667h5.7a3.176 3.176 0 0 1 3.167 3.167zM3.264 5.48A3.236 3.236 0 1 1 6.5 8.717a3.236 3.236 0 0 1-3.236-3.236z" /></svg>
      ...
      {/* Restaurant Detail */}
      <div className="mt-2 mb-1 text-sm font-light text-gray-600 dark:text-gray-400">
        {restaurant_detail}
      </div>
