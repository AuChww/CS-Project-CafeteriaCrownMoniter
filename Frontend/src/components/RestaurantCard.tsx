...
const RestaurantCard: React.FC<Restaurant> = ({
  ...
  return (
    <div
      key={restaurant_id}
      className=" bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 transition-transform transform hover:scale-105 duration-300"
    >
      {/* Image Section */}
      <a href="#">
        {imageUrl ? (
      ...
      <div className="p-5">
        ...
        {/* Visitor Count */}
        <div className="flex space-x-1 text-sm  dark:text-gray-400 ">
