...
const MonthZoneVisitorBarChart: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetch("http://127.0.0.1:8000/api/v1/getAllZoneVisitorHistory")
      ...
      .then((data) => {
        ...
        thirtyDaysAgo.setDate(today.getDate() - 30);  // Change this line to 30 days
        ...
        const filteredData: ChartData[] = visitorHistories.reduce<ChartData[]>((acc, curr) => {
          ...
          if (recordDate >= thirtyDaysAgo && recordDate <= today) {  // Change this line to use 30 days
  ...
  return (
    <div className="text-center relative">
      <h3>Visitor Count by Zone (30 Days Before)</h3> {/* Change the text here to "Last 30 Days" */}
      <BarChart
        width={600}
        height={200}
        data={chartData}
