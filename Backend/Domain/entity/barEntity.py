class BarEntity:
    def __init__(self, bar_id, bar_name, bar_location, bar_detail=None, current_visitor_count=0, max_people_in_bar=0, bar_rating=0, total_rating=0, total_reviews=0, bar_image=None):
        self.bar_id = bar_id
