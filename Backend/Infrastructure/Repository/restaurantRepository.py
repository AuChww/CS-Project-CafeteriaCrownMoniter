...
def add_restaurant(zone_id, restaurant_name, restaurant_location, restaurant_detail, restaurant_image=None):
    ...
    cur.execute(
        'INSERT INTO restaurant (zone_id, restaurant_name, restaurant_location, restaurant_detail, restaurant_rating, total_rating, total_review, restaurant_image, current_visitor_count) '
        'VALUES (%s, %s, %s, %s, %s) RETURNING restaurant_id',
        (zone_id, restaurant_name, restaurant_location, restaurant_detail, restaurant_rating, total_rating, total_review, restaurant_image, current_visitor_count)
    )
